...
source /dev/stdin <<<$(curl -fsSL n/misc/api.func)
...
qm set $VMID \
  ...
  -boot order=scsi0 \
  -description "<div align='center'><a href='https://Helper-Scripts.com' target='_blank' rel='noopener noreferrer'><img src='n/misc/images/logo-81x112.png'/></a>
